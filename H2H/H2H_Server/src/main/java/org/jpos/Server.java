...
public class Server {
    ...
    public static void main(String[] args) throws Exception {
        //XMLChannel clientSide = new XMLChannel(new XMLPackager());
         HEXChannel clientSide = new HEXChannel();
        
        // without a logger on theclientSide channel we don't see send and receive only session-start and -end
        ...
        clientSide.send(isoMsg);

        ISOMsg r = clientSide.receive ();
